...
import { approveSubmission, deleteItem } from "./actions";
...
function DeleteItemButton({ jobId }: AdminButtonProps) {
    const [formState, formAction] = useFormState(deleteItem, undefined);
